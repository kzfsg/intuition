...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Intuition in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Intuition and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
